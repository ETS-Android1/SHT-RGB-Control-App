...
public final class Fragment50Binding implements ViewBinding {
  @NonNull
  ...
  private Fragment50Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static Fragment50Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Fragment50Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_50, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Fragment50Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment50Binding((ConstraintLayout) rootView, RGBColorPicker, button1, button10,
