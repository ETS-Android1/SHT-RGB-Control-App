...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull Button buttonFirst, @NonNull Button buttonThird, @NonNull TextView textviewFirst,
      @NonNull Spinner tvSpinner) {
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, button, buttonFirst, buttonThird,
          textviewFirst, tvSpinner);
    }
