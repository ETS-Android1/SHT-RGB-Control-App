...
public final class Fragment32Binding implements ViewBinding {
  ...
  private Fragment32Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static Fragment32Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Fragment32Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_32, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Fragment32Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment32Binding((ConstraintLayout) rootView, RGBColorPicker, button1, button10,
