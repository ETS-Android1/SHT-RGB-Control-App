...
public final class Fragment42Binding implements ViewBinding {
  @NonNull
  ...
  private Fragment42Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static Fragment42Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Fragment42Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_42, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Fragment42Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment42Binding((ConstraintLayout) rootView, RGBColorPicker, button1, button10,
