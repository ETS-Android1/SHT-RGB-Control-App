...
public final class FragmentAIBinding implements ViewBinding {
  ...
  private FragmentAIBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonback2,
      @NonNull ConstraintLayout frameLayout, @NonNull ToggleButton toggleButton) {
  ...
  public static FragmentAIBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_a_i, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentAIBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAIBinding((ConstraintLayout) rootView, buttonback2, frameLayout,
          toggleButton);
    }
